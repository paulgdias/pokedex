...
const cardClass = `max-w-sm rounded-2xl shadow-lg cursor-pointer hover:shadow-2xl border-4 border-amber-200`; // transition-transform duration-300 ease-out transform hover:scale-105
...
const placeholderClass = `rounded-full px-1 py-1 text-sm font-semibold text-white mr-2 mb-2 border-1 border-black text-shadow-sm/40`;
