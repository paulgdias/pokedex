...
const cardClass = `flex flex-col justify-between max-w-sm rounded-2xl shadow-lg cursor-pointer hover:shadow-2xl border-4 border-amber-200`; // transition-transform duration-300 ease-out transform hover:scale-105
...
const legendaryPokemonClass = `text-gray-300 animate-pulse fixed m-2`;
const mythicalPokemonClass = `text-yellow-400 animate-pulse fixed m-2`;
